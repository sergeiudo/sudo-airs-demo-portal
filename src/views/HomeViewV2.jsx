...
export const PILLARS = [
  ...
  },
  {
    ...
    tag: 'Model & Skill Security',
    summary: 'Scan AI models and agent skills before they are trusted, let alone loaded.',
    description: 'Scan model artifacts for code that runs on load, unsafe serialisation, license and publisher violations before they are deployed — from a Hugging Face URI or a local upload. Browse every model scan in your SCM tenant, and see how AI Skill Security (Preview) evaluates agent skills.',
    highlights: ['Pickle / Keras / PyTorch payload detection', 'Hugging Face + local file scanning', 'PAIT threat IDs with remediation', { t: 'SCM scan history — every model scan in your tenant', tag: 'NEW' }],
    accent: '#6366f1',
